...
BB_LIBRARY: Dict[str, List[str]] = {
    ...
    # Ditopic (L2) linkers — includes imide-forming dianhydrides
    "L2_linkers": [
        "L2_BENZ",    # benzene-1,4-dicarbaldehyde (imine/hydrazone)
        "L2_NAPH",    # naphthalene dicarbaldehyde
        "L2_BIPH",    # biphenyl dicarbaldehyde
        "L2_TPHN",    # terphenyl dicarbaldehyde
        "L2_ANTR",    # anthracene dicarbaldehyde
        "L2_PYRN",    # pyrene dicarbaldehyde
        "L2_AZBN",    # azobenzene dicarbaldehyde
        "L2_ETBE",    # ethynylene-bridged dialdehyde
        "L2_STIL",    # stilbene dicarbaldehyde
        "L2_BTTA",    # BT-based dialdehyde
        "L2_PMDA",    # pyromellitic dianhydride (imide)
        "L2_NTCDA",   # naphthalene-1,4,5,8-tetracarboxylic dianhydride (imide)
        "L2_BTDA",    # benzophenone-3,3',4,4'-tetracarboxylic dianhydride (imide)
    ],
    ...
    "conn_groups": {
        ...
        "hydrazone":       ("NHNH2",  "CHO"),
        "triazine":        ("CN",     "CN"),
        "imide":           ("NH2",    "anhydride"),  # amine + dianhydride → imide ring
    },
}
